...
public class DayRecord {
    ...
    public DayRecord(Long id) {
        this.id = id;
    }

    public DayRecord(Long id, java.util.Date date, Boolean yesuan, Boolean aiai, Boolean sport, Boolean yjstart, Boolean yjend, Float tiwen, Integer szpl, Integer szzy, Integer baidai, Integer feeling, String symptom, String note) {
        this.id = id;
        this.date = date;
        this.yesuan = yesuan;
        this.aiai = aiai;
